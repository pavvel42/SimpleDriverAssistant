...
export const onUpdateCollectionLocationUser = functions.firestore.document('users/{uid}/locationUser/{email}')
...
function distance(x1 : number,y1 : number, x2 : number, y2 : number) {
    ...
    console.log("x1 "+x1+" y1 "+y1+" x2 "+x2+" y2 "+y2+" odległość między pkt. wynosi = "+dis*1000+" m")
    return dis*1000;
}
